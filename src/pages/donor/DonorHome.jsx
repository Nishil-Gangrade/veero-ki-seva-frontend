...
const DonorHome = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] text-center text-white px-4">
        ...
        <div className="max-w-3xl mt-16">
          ...
          <p className="text-lg sm:text-xl mb-4 drop-shadow">
            Thank you for being here. By donating or participating, you’re
            supporting the families of our real heroes — the bravehearts who
            gave their lives for our nation.
          </p>
          <p className="text-base sm:text-lg mb-4 drop-shadow ">
            We believe that true patriotism is when we stand by those who stood
            for us.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
            ...
            <a
              href="#footer"
              className="bg-white text-gray-800 font-semibold px-6 py-2 rounded-full hover:bg-gray-300 transition"
            >
              Know More
            </a>
          </div>
        ...
        <div className="horizontal-scroll whitespace-nowrap animate-scroll">
          {[...cardImages, ...cardImages].map((img, idx) => {
            ...
            return (
              <div
                key={idx}
                className="inline-block w-64 h-64 mx-4 relative group overflow-hidden rounded-xl"
              >
                <img
                  src={img}
                  alt={`Card ${idx}`}
      ...
      <footer
        id="footer"
        className="relative z-10 bg-slate-200 bg-opacity-80 backdrop-blur-md shadow-md text-gray-800 py-14 px-8 mt-10"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h2 className="text-xl font-bold mb-3">About VEEROKISEVA</h2>
            <p className="text-sm text-gray-700 leading-relaxed">
              <span className="font-semibold text-black">VEEROKISEVA</span> is a{" "}
              <span className="text-orange-600 font-medium">
                tech-for-good initiative
              </span>{" "}
              dedicated to honoring the sacrifices of our brave Indian soldiers
              by supporting their families — the unsung heroes left behind.
              <br />
              <br />
              Through a transparent and community-driven platform, we connect
              donors, volunteers, and organizations to directly uplift martyrs’
              families. Whether it’s funding a child’s education, sponsoring a
              daughter’s wedding, or supporting elderly parents, every
              contribution creates real impact.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/in/nishil-g"
                className="hover:text-orange-600"
              >
                LinkedIn
              </a>
              <a href="https://x.com/Ni5hil" className="hover:text-orange-600">
                Twitter
              </a>
              <a
                href="https://github.com/Nishil-Gangrade"
                className="hover:text-orange-600"
              >
                GitHub
              </a>
